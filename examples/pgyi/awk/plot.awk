...
action == "validate" && NR > 1 && aspect != "" && aspect !~ /^(E|N|NE|NW|S|SE|SW|W|NA)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "aspect value should match: /^(E|N|NE|NW|S|SE|SW|W|NA)$/" FS "aspect"} 
...
action == "validate" && NR > 1 && x_coord != "" && x_coord < 240000 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "minimum" FS "error" FS  "x_coord value should be greater or equal to: 240000" FS "x_coord"} 
...
action == "validate" && NR > 1 && x_coord != "" && x_coord > 850000 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "maximum" FS "error" FS  "x_coord value should be less or equal to: 850000" FS "x_coord"} 
...
action == "validate" && NR > 1 && x_coord != "" && x_coord !~ /^[0-9]*.[0-9]{5}$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "x_coord value should match: /^[0-9]*.[0-9]{5}$/" FS "x_coord"} 
...
action == "validate" && NR > 1 && y_coord != "" && y_coord < 5400000 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "minimum" FS "error" FS  "y_coord value should be greater or equal to: 5400000" FS "y_coord"} 
...
action == "validate" && NR > 1 && y_coord != "" && y_coord > 6650000 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "maximum" FS "error" FS  "y_coord value should be less or equal to: 6650000" FS "y_coord"} 
...
action == "validate" && NR > 1 && y_coord != "" && y_coord !~ /^[0-9]*.[0-9]{5}$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "y_coord value should match: /^[0-9]*.[0-9]{5}$/" FS "y_coord"} 
...
action == "validate" && NR > 1 && latitude != "" && latitude !~ /^[0-9]*.[0-9]{10}$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "latitude value should match: /^[0-9]*.[0-9]{10}$/" FS "latitude"} 
...
action == "validate" && NR > 1 && longitude != "" && longitude !~ /^-[0-9]*.[0-9]{10}$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "longitude value should match: /^-[0-9]*.[0-9]{10}$/" FS "longitude"} 
...
action == "validate" && NR > 1 && natural_subregion != "" && natural_subregion !~ /^(ALP|AP|BSA|CM|CP|DM|DMG|FF|FP|KU|LBH|LF|MG|MT|NF|NM|PAD|PRP|SA|UBH|UF)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "natural_subregion value should match: /^(ALP|AP|BSA|CM|CP|DM|DMG|FF|FP|KU|LBH|LF|MG|MT|NF|NM|PAD|PRP|SA|UBH|UF)$/" FS "natural_subregion"} 
...
action == "validate" && NR > 1 && ecosite_guide != "" && ecosite_guide !~ /^(N|SW|WC)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "ecosite_guide value should match: /^(N|SW|WC)$/" FS "ecosite_guide"} 
...
action == "validate" && NR > 1 && ecosite_phase != "" && ecosite_phase !~ /^(a1|a2|a3|b1|b2|b3|b4|b5|c1|c2|c3|c4|c5|d1|d2|d3|d4|e1|e2|e3|e4|f1|f2|f3|f4|f5|f6|g1|g2|g3|h1|h2|h3|i1|i2|i3|j1|j2|j3|k1|k2|k3|l1|l2|l3|m1|m2|m3|n1)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number FS "pattern" FS "error" FS  "ecosite_phase value should match: /^(a1|a2|a3|b1|b2|b3|b4|b5|c1|c2|c3|c4|c5|d1|d2|d3|d4|e1|e2|e3|e4|f1|f2|f3|f4|f5|f6|g1|g2|g3|h1|h2|h3|i1|i2|i3|j1|j2|j3|k1|k2|k3|l1|l2|l3|m1|m2|m3|n1)$/" FS "ecosite_phase"} 
