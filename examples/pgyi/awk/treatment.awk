...
action == "validate" && NR > 1 && treatment_code != "" && treatment_code !~ /^(B|C|CT|D|F|FI|H|M|NK|NT|P|PC|S|SA|SM|TH|TW|UP|UA)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" treatment_number FS "pattern" FS "error" FS  "treatment_code value should match: /^(B|C|CT|D|F|FI|H|M|NK|NT|P|PC|S|SA|SM|TH|TW|UP|UA)$/" FS "treatment_code"} 
