...
action == "validate" && NR > 1 && company != "" && company !~ /^(AINS|ALPC|ANC|APLY|BLUE|CFPL|CFS|DAIS|FOFP|GOA|HPFP|HLFP|MDFP|MWWC|SFPI|SLPC|SPRA|SUND|TOLK|TOSL|UNKN|UOA|VAND|WFML|WYGP|WYPM)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "pattern" FS "error" FS  "company value should match: /^(AINS|ALPC|ANC|APLY|BLUE|CFPL|CFS|DAIS|FOFP|GOA|HPFP|HLFP|MDFP|MWWC|SFPI|SLPC|SPRA|SUND|TOLK|TOSL|UNKN|UOA|VAND|WFML|WYGP|WYPM)$/" FS "company"} 
...
action == "validate" && NR > 1 && disturbance_code != "" && disturbance_code !~ /^(BU|DA|DC|DF|HL|MI|MLU|MU|NDD|NDW|NDC|NDI)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "pattern" FS "error" FS  "disturbance_code value should match: /^(BU|DA|DC|DF|HL|MI|MLU|MU|NDD|NDW|NDC|NDI)$/" FS "disturbance_code"} 
