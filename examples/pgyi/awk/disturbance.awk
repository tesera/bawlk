...
action == "validate" && NR > 1 && NF != field_width { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "invalid-column-count" FS "error" FS  "row " NR " has an invalid column count" FS ""} 
...
action == "validate" && NR > 1 && company == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "error" FS  "company value is required but was empty" FS "company"} 
...
action == "validate" && NR > 1 && company != "" && company !~ /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "pattern" FS "error" FS  "company value should match: /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/" FS "company"} 
...
action == "validate" && NR > 1 && company_plot_number == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "error" FS  "company_plot_number value is required but was empty" FS "company_plot_number"} 
...
action == "validate" && NR > 1 && company_plot_number != "" && length(company_plot_number) > 15 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "maxLength" FS "error" FS  "company_plot_number max length is: 15" FS "company_plot_number"} 
...
action == "validate" && NR > 1 && disturbance_number && !is_integer(disturbance_number) { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "type" FS "error" FS  "disturbance_number should be an integer" FS "disturbance_number"} 
...
action == "validate" && NR > 1 && disturbance_number == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "error" FS  "disturbance_number value is required but was empty" FS "disturbance_number"} 
...
action == "validate" && NR > 1 && disturbance_number != "" && disturbance_number < 1 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "minimum" FS "error" FS  "disturbance_number value should be greater or equal to: 1" FS "disturbance_number"} 
...
action == "validate" && NR > 1 && disturbance_number != "" && disturbance_number > 12 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "maximum" FS "error" FS  "disturbance_number value should be less or equal to: 12" FS "disturbance_number"} 
...
action == "validate" && NR > 1 && disturbance_code == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "error" FS  "disturbance_code value is required but was empty" FS "disturbance_code"} 
...
action == "validate" && NR > 1 && disturbance_code != "" && disturbance_code !~ /^(BU|DF|MI|MU|NDD|NDW|DC|HL|MLU|NDC|NDI|DA)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "pattern" FS "error" FS  "disturbance_code value should match: /^(BU|DF|MI|MU|NDD|NDW|DC|HL|MLU|NDC|NDI|DA)$/" FS "disturbance_code"} 
action == "validate:summary" && NR > 1 && disturbance_code != "" && disturbance_code !~ /^(BU|DF|MI|MU|NDD|NDW|DC|HL|MLU|NDC|NDI|DA)$/ { key=CSVFILENAME FS "disturbance_code" FS  "pattern" FS "disturbance_code value should match: /^(BU|DF|MI|MU|NDD|NDW|DC|HL|MLU|NDC|NDI|DA)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
action == "validate" && NR > 1 && disturbance_year && !is_integer(disturbance_year) { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "type" FS "error" FS  "disturbance_year should be an integer" FS "disturbance_year"} 
...
action == "validate" && NR > 1 && disturbance_year == "" { log_err("warning"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "warning" FS  "disturbance_year value is required but was empty" FS "disturbance_year"} 
...
action == "validate" && NR > 1 && disturbance_year != "" && disturbance_year < 1900 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "minimum" FS "error" FS  "disturbance_year value should be greater or equal to: 1900" FS "disturbance_year"} 
...
action == "validate" && NR > 1 && disturbance_year != "" && disturbance_year > 2050 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "maximum" FS "error" FS  "disturbance_year value should be less or equal to: 2050" FS "disturbance_year"} 
...
action == "validate" && NR > 1 && disturbance_month && !is_integer(disturbance_month) { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "type" FS "error" FS  "disturbance_month should be an integer" FS "disturbance_month"} 
...
action == "validate" && NR > 1 && disturbance_month == "" { log_err("warning"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "warning" FS  "disturbance_month value is required but was empty" FS "disturbance_month"} 
...
action == "validate" && NR > 1 && disturbance_month != "" && disturbance_month < 1 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "minimum" FS "error" FS  "disturbance_month value should be greater or equal to: 1" FS "disturbance_month"} 
...
action == "validate" && NR > 1 && disturbance_month != "" && disturbance_month > 12 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "maximum" FS "error" FS  "disturbance_month value should be less or equal to: 12" FS "disturbance_month"} 
...
action == "validate" && NR > 1 && disturbance_day && !is_integer(disturbance_day) { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "type" FS "error" FS  "disturbance_day should be an integer" FS "disturbance_day"} 
...
action == "validate" && NR > 1 && disturbance_day == "" { log_err("warning"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "required" FS "warning" FS  "disturbance_day value is required but was empty" FS "disturbance_day"} 
...
action == "validate" && NR > 1 && disturbance_day != "" && disturbance_day < 1 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "minimum" FS "error" FS  "disturbance_day value should be greater or equal to: 1" FS "disturbance_day"} 
...
action == "validate" && NR > 1 && disturbance_day != "" && disturbance_day > 31 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "maximum" FS "error" FS  "disturbance_day value should be less or equal to: 31" FS "disturbance_day"} 
...
action == "validate" && NR > 1 && disturbance_comment != "" && length(disturbance_comment) > 250 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" disturbance_number FS "maxLength" FS "error" FS  "disturbance_comment max length is: 250" FS "disturbance_comment"} 
