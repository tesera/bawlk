...
action == "validate" && NR > 1 && disturbance_code!='' && disturbance_year == "" { log_err("warning"); print "Field disturbance_year in " FILENAME " line " NR " is required if disturbance_code!=''" RS $0 RS; } 
