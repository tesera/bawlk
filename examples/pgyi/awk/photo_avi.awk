...
action == "validate" && NR > 1 && company != "" && company !~ /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "company value should match: /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/" FS "company"} 
...
action == "validate" && NR > 1 && sp1 != "" && sp1 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|No)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "sp1 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|No)$/" FS "sp1"} 
action == "validate:summary" && NR > 1 && sp1 != "" && sp1 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|No)$/ { key=CSVFILENAME FS "sp1" FS  "pattern" FS "sp1 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|No)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && sp2 != "" && sp2 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "sp2 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "sp2"} 
action == "validate:summary" && NR > 1 && sp2 != "" && sp2 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { key=CSVFILENAME FS "sp2" FS  "pattern" FS "sp2 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && sp3 != "" && sp3 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "sp3 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "sp3"} 
action == "validate:summary" && NR > 1 && sp3 != "" && sp3 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { key=CSVFILENAME FS "sp3" FS  "pattern" FS "sp3 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && sp4 != "" && sp4 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "sp4 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "sp4"} 
action == "validate:summary" && NR > 1 && sp4 != "" && sp4 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { key=CSVFILENAME FS "sp4" FS  "pattern" FS "sp4 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && sp5 != "" && sp5 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "sp5 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "sp5"} 
action == "validate:summary" && NR > 1 && sp5 != "" && sp5 !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/ { key=CSVFILENAME FS "sp5" FS  "pattern" FS "sp5 value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && struc != "" && struc !~ /^(S|M|C|H)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "struc value should match: /^(S|M|C|H)$/" FS "struc"} 
action == "validate:summary" && NR > 1 && struc != "" && struc !~ /^(S|M|C|H)$/ { key=CSVFILENAME FS "struc" FS  "pattern" FS "struc value should match: /^(S|M|C|H)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && tpr != "" && tpr !~ /^(U|F|M|G)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "tpr value should match: /^(U|F|M|G)$/" FS "tpr"} 
action == "validate:summary" && NR > 1 && tpr != "" && tpr !~ /^(U|F|M|G)$/ { key=CSVFILENAME FS "tpr" FS  "pattern" FS "tpr value should match: /^(U|F|M|G)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && nfl != "" && nfl !~ /^(SC|SO|HG|HF|BR)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "nfl value should match: /^(SC|SO|HG|HF|BR)$/" FS "nfl"} 
action == "validate:summary" && NR > 1 && nfl != "" && nfl !~ /^(SC|SO|HG|HF|BR)$/ { key=CSVFILENAME FS "nfl" FS  "pattern" FS "nfl value should match: /^(SC|SO|HG|HF|BR)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && nat_non != "" && nat_non !~ /^(NWI|NWL|NWR|NWF|NMB|NMC|NMR|NMS)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "nat_non value should match: /^(NWI|NWL|NWR|NWF|NMB|NMC|NMR|NMS)$/" FS "nat_non"} 
action == "validate:summary" && NR > 1 && nat_non != "" && nat_non !~ /^(NWI|NWL|NWR|NWF|NMB|NMC|NMR|NMS)$/ { key=CSVFILENAME FS "nat_non" FS  "pattern" FS "nat_non value should match: /^(NWI|NWL|NWR|NWF|NMB|NMC|NMR|NMS)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && mod1 != "" && mod1 !~ /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "mod1 value should match: /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/" FS "mod1"} 
action == "validate:summary" && NR > 1 && mod1 != "" && mod1 !~ /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/ { key=CSVFILENAME FS "mod1" FS  "pattern" FS "mod1 value should match: /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && mod1_yr != "" && mod1_yr < 1900 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "minimum" FS "error" FS  "mod1_yr value should be greater or equal to: 1900" FS "mod1_yr"} 
action == "validate:summary" && NR > 1 && mod1_yr != "" && mod1_yr < 1900 { key=CSVFILENAME FS "mod1_yr" FS  "minimum" FS "mod1_yr value should be greater or equal to: 1900" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && mod2 != "" && mod2 !~ /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "mod2 value should match: /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/" FS "mod2"} 
action == "validate:summary" && NR > 1 && mod2 != "" && mod2 !~ /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/ { key=CSVFILENAME FS "mod2" FS  "pattern" FS "mod2 value should match: /^(CC|BU|WF|CL|DI|IK|UK|WE|DT|BT|SN|ST|SI|SC|PL|TH|GR|IR)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && mod2_yr != "" && mod2_yr < 1900 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "minimum" FS "error" FS  "mod2_yr value should be greater or equal to: 1900" FS "mod2_yr"} 
action == "validate:summary" && NR > 1 && mod2_yr != "" && mod2_yr < 1900 { key=CSVFILENAME FS "mod2_yr" FS  "minimum" FS "mod2_yr value should be greater or equal to: 1900" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && data != "" && data !~ /^(F|A|I|S|P|C|V|L)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "pattern" FS "error" FS  "data value should match: /^(F|A|I|S|P|C|V|L)$/" FS "data"} 
action == "validate:summary" && NR > 1 && data != "" && data !~ /^(F|A|I|S|P|C|V|L)$/ { key=CSVFILENAME FS "data" FS  "pattern" FS "data value should match: /^(F|A|I|S|P|C|V|L)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && data_yr != "" && data_yr < 1900 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" polygon_number "-" year_photography "-" layer_type FS "minimum" FS "error" FS  "data_yr value should be greater or equal to: 1900" FS "data_yr"} 
action == "validate:summary" && NR > 1 && data_yr != "" && data_yr < 1900 { key=CSVFILENAME FS "data_yr" FS  "minimum" FS "data_yr value should be greater or equal to: 1900" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "insert" && NR == 1 {
    ...
    print "COPY " schema "photo_avi_layer (" addfields FS "source_row_index" FS $0 ") FROM stdin;"
}
action == "insert" && NR > 1 {
   record = addvals "\t" NR
   for (i = 1; i <= NF; i++) {
