...
action ~ /^(sanitize|insert)$/ && NR > 1 {
    if (regen_tagging_limit_decid == "") $21 = "NULL"
    if (measurement_year == "") $4 = "NULL"
    if (regen_plot_shape == "") $19 = "NULL"
    if (moss_lichen_cover == "") $29 = "NULL"
    if (number_regen_plots == "") $22 = "NULL"
    if (stand_type == "") $9 = "NULL"
    if (measurement_day == "") $6 = "NULL"
    if (plot_measurement_comment == "") $31 = "NULL"
    if (avi_field_call == "") $30 = "NULL"
    if (sapling_plot_area == "") $14 = "NULL"
    if (sapling_plot_shape == "") $15 = "NULL"
    if (plot_type == "") $8 = "NULL"
    if (regen_tagging_limit_conifer == "") $20 = "NULL"
    if (contractor == "") $23 = "NULL"
    if (grass_cover == "") $28 = "NULL"
    if (measurement_number == "") $3 = "NULL"
    if (company_plot_number == "") $2 = "NULL"
    if (shrub_cover == "") $26 = "NULL"
    if (tree_tagging_limit == "") $13 = "NULL"
    if (plot_status == "") $10 = "NULL"
    if (sapling_tagging_limit_dbh == "") $16 = "NULL"
    if (measurement_month == "") $5 = "NULL"
    if (cruiser_1_name == "") $24 = "NULL"
    if (cruiser_2_name == "") $25 = "NULL"
    if (stand_origin == "") $7 = "NULL"
    if (tree_plot_shape == "") $12 = "NULL"
    if (tree_plot_area == "") $11 = "NULL"
    if (herb_forb_cover == "") $27 = "NULL"
    if (company == "") $1 = "NULL"
    if (sapling_tagging_limit_height == "") $17 = "NULL"
    if (regen_plot_area == "") $18 = "NULL"
}
