...
action == "validate" && NR > 1 && sapling_plot_area>0 && sapling_tagging_limit_dbh == "" { log_err("warning"); print "Field sapling_tagging_limit_dbh in " FILENAME " line " NR " is required if sapling_plot_area>0" RS $0 RS; } 
...
action == "validate" && NR > 1 && sapling_plot_area>0 && sapling_tagging_limit_height == "" { log_err("warning"); print "Field sapling_tagging_limit_height in " FILENAME " line " NR " is required if sapling_plot_area>0" RS $0 RS; } 
...
action == "validate" && NR > 1 && contractor != "" && length(contractor) > 50 { log_err("warning"); print "contractor length in " FILENAME " line " NR " should be less than 50 and was " length(contractor) " " RS $0 RS; } 
action == "validate" && NR > 1 && cruiser_1_name != "" && length(cruiser_1_name) > 25 { log_err("warning"); print "cruiser_1_name length in " FILENAME " line " NR " should be less than 25 and was " length(cruiser_1_name) " " RS $0 RS; } 
action == "validate" && NR > 1 && cruiser_2_name != "" && length(cruiser_2_name) > 25 { log_err("warning"); print "cruiser_2_name length in " FILENAME " line " NR " should be less than 25 and was " length(cruiser_2_name) " " RS $0 RS; } 
