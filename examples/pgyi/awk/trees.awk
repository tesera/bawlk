...
action == "validate" && NR > 1 && tree_label != "" && length(tree_label) > 15 { log_err("warning"); print "tree_label length in " FILENAME " line " NR " should be less than 15 and was " length(tree_label) " " RS $0 RS; } 
...
action == "validate" && NR > 1 && sector_or_quarter != "" && length(sector_or_quarter) > 15 { log_err("warning"); print "sector_or_quarter length in " FILENAME " line " NR " should be less than 15 and was " length(sector_or_quarter) " " RS $0 RS; } 
