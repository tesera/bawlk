...
action == "validate" && NR > 1 && species != "" && species !~ /^(A|Aw|Ax|Bw|Fa|Fb|Fd|La|Ls|Lt|Lw|Ms|P|Pa|Pb|Pf|Pj|Pl|Pw|Px|Sb|Se|Sw|Sx|No)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "pattern" FS "error" FS  "species value should match: /^(A|Aw|Ax|Bw|Fa|Fb|Fd|La|Ls|Lt|Lw|Ms|P|Pa|Pb|Pf|Pj|Pl|Pw|Px|Sb|Se|Sw|Sx|No)$/" FS "species"} 
