...
action == "validate" && NR > 1 && regeneration_count != "" && regeneration_count < 0 { log_err("warning"); print "regeneration_count in " FILENAME " line " NR " should be greater than 0 and was " regeneration_count " " RS $0 RS; } 
