...
action == "validate" && NR > 1 && NF != field_width { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "invalid-column-count" FS "error" FS  "row " NR " has an invalid column count" FS ""} 
...
action == "validate" && NR > 1 && company == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "required" FS "error" FS  "company value is required but was empty" FS "company"} 
...
action == "validate" && NR > 1 && company != "" && company !~ /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "pattern" FS "error" FS  "company value should match: /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/" FS "company"} 
...
action == "validate" && NR > 1 && company_plot_number == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "required" FS "error" FS  "company_plot_number value is required but was empty" FS "company_plot_number"} 
...
action == "validate" && NR > 1 && company_plot_number != "" && length(company_plot_number) > 15 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "maxLength" FS "error" FS  "company_plot_number max length is: 15" FS "company_plot_number"} 
...
action == "validate" && NR > 1 && measurement_number && !is_integer(measurement_number) { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "type" FS "error" FS  "measurement_number should be an integer" FS "measurement_number"} 
...
action == "validate" && NR > 1 && measurement_number == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "required" FS "error" FS  "measurement_number value is required but was empty" FS "measurement_number"} 
...
action == "validate" && NR > 1 && measurement_number != "" && length(measurement_number) > 2 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "maxLength" FS "error" FS  "measurement_number max length is: 2" FS "measurement_number"} 
...
action == "validate" && NR > 1 && regeneration_plot_name == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "required" FS "error" FS  "regeneration_plot_name value is required but was empty" FS "regeneration_plot_name"} 
...
action == "validate" && NR > 1 && regeneration_plot_name != "" && regeneration_plot_name !~ /^(R1|R2|R3|R4|R5|R6|R7|R8|R9|R10)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "pattern" FS "error" FS  "regeneration_plot_name value should match: /^(R1|R2|R3|R4|R5|R6|R7|R8|R9|R10)$/" FS "regeneration_plot_name"} 
...
action == "validate" && NR > 1 && species == "" { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "required" FS "error" FS  "species value is required but was empty" FS "species"} 
...
action == "validate" && NR > 1 && species != "" && species !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|Ms|No)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "pattern" FS "error" FS  "species value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|Ms|No)$/" FS "species"} 
action == "validate:summary" && NR > 1 && species != "" && species !~ /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|Ms|No)$/ { key=CSVFILENAME FS "species" FS  "pattern" FS "species value should match: /^(A|Aw|Pb|Bw|Ax|P|Pl|Pw|Pa|Pf|Pj|Px|Sw|Se|Sb|Sx|Fb|Fa|Fd|Lt|Lw|La|Ls|Ms|No)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
action == "validate" && NR > 1 && regeneration_count && !is_integer(regeneration_count) { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "type" FS "error" FS  "regeneration_count should be an integer" FS "regeneration_count"} 
...
action == "validate" && NR > 1 && regeneration_count != "" && regeneration_count < 0 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "minimum" FS "error" FS  "regeneration_count value should be greater or equal to: 0" FS "regeneration_count"} 
...
action == "validate" && NR > 1 && regeneration_count != "" && regeneration_count > 9999 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "maximum" FS "error" FS  "regeneration_count value should be less or equal to: 9999" FS "regeneration_count"} 
...
action == "validate" && NR > 1 && regeneration_comment != "" && length(regeneration_comment) > 250 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" regeneration_plot_name "-" species FS "maxLength" FS "error" FS  "regeneration_comment max length is: 250" FS "regeneration_comment"} 
