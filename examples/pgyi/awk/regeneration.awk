...
action == "validate" && NR > 1 && regeneration_count != "" && regeneration_count < species { log_err("=="); print "regeneration_count in " FILENAME " line " NR " should be greater than species and was " regeneration_count " " RS $0 RS; } 
