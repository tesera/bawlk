...
action == "validate" && NR > 1 && company != "" && company !~ /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" tree_number FS "pattern" FS "error" FS  "company value should match: /^(AINS|GOA|APLY|ALPC|ANC|BLUE|CFPL|CFS|DAIS|FOFP|MDFP|MWWC|SLPC|SPRA|SUND|SFPI|HLFP|TOLK|TOSL|UOA|VAND|WFML|WYGP|WYPM|UNKN|HPFP)$/" FS "company"} 
...
action == "validate" && NR > 1 && tree_number != "" && tree_number < 1 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" tree_number FS "minimum" FS "error" FS  "tree_number value should be greater or equal to: 1" FS "tree_number"} 
...
action == "validate" && NR > 1 && tree_type != "" && tree_type !~ /^(T|S|ES|ET|B|R1|R2|R3|R4|R5|R6|R7|R8|R9|R10)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" tree_number FS "pattern" FS "error" FS  "tree_type value should match: /^(T|S|ES|ET|B|R1|R2|R3|R4|R5|R6|R7|R8|R9|R10)$/" FS "tree_type"} 
action == "validate:summary" && NR > 1 && tree_type != "" && tree_type !~ /^(T|S|ES|ET|B|R1|R2|R3|R4|R5|R6|R7|R8|R9|R10)$/ { key=CSVFILENAME FS "tree_type" FS  "pattern" FS "tree_type value should match: /^(T|S|ES|ET|B|R1|R2|R3|R4|R5|R6|R7|R8|R9|R10)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && crown_class != "" && crown_class !~ /^(D|C|I|S|N)$/ { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" tree_number FS "pattern" FS "error" FS  "crown_class value should match: /^(D|C|I|S|N)$/" FS "crown_class"} 
action == "validate:summary" && NR > 1 && crown_class != "" && crown_class !~ /^(D|C|I|S|N)$/ { key=CSVFILENAME FS "crown_class" FS  "pattern" FS "crown_class value should match: /^(D|C|I|S|N)$/" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && crown_diameter_ns != "" && crown_diameter_ns < 1 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" tree_number FS "minimum" FS "error" FS  "crown_diameter_ns value should be greater or equal to: 1" FS "crown_diameter_ns"} 
action == "validate:summary" && NR > 1 && crown_diameter_ns != "" && crown_diameter_ns < 1 { key=CSVFILENAME FS "crown_diameter_ns" FS  "minimum" FS "crown_diameter_ns value should be greater or equal to: 1" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
...
action == "validate" && NR > 1 && crown_diameter_ew != "" && crown_diameter_ew < 1 { log_err("error"); print  NR FS CSVFILENAME FS company "-" company_plot_number "-" measurement_number "-" tree_number FS "minimum" FS "error" FS  "crown_diameter_ew value should be greater or equal to: 1" FS "crown_diameter_ew"} 
action == "validate:summary" && NR > 1 && crown_diameter_ew != "" && crown_diameter_ew < 1 { key=CSVFILENAME FS "crown_diameter_ew" FS  "minimum" FS "crown_diameter_ew value should be greater or equal to: 1" FS "error"; if(!violations[key]) { violations[key]=0; } violations[key]++; } 
